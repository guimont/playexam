...
insert into "answers" values (1, 1, 'A.	public static int main(char args[]');
insert into "answers" values (2, 1, 'B.	public static void main(String args[])');
insert into "answers" values (3, 1, 'C.	public static void MAIN(String args[])');
insert into "answers" values (4, 1, 'D.	public static void main(String args)');
insert into "answers" values (5, 1, 'E.	public static void main(char args[])');
...
insert into "answers" values (6, 2, 'A.	i=0 j=0');
insert into "answers" values (7, 2, 'B.	i=0 j=1');
insert into "answers" values (8, 2, 'C.	i=0 j=2');
insert into "answers" values (9, 2, 'D.	i=1 j=0');
insert into "answers" values (10, 2, 'E.	i=1 j=1');
insert into "answers" values (11, 2, 'F.	i=1 j=2');
insert into "answers" values (12, 2, 'G.	i=2 j=0');
insert into "answers" values (13, 2, 'H.	i=2 j=1');
insert into "answers" values (14, 2, 'I.	i=2 j=2');
